...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Robótica}
\newcommand{\subtitulo}{Memoria - Trabajo de teoría sobre ROS/ROS2}
% Datos del autor
\newcommand{\miNombre}{Welton Vieira dos Santos\\Rubén Cendón Villar\\Sara Portas Valdivieso}
\newcommand{\miDNI}{49205764-R}
\newcommand{\miEmail}{welton.dossantos@udc.es}
%% Datos del tutor/es
\newcommand{\miTutor}{Alejandro Paz López (alejandro.paz.lopez@udc.es)}
\newcommand{\miTutorB}{Francisco Javier Bellas Bouza (francisco.bellas@udc.es)}
...
\newcommand{\tipotrabajo}{Trabajo de teoría}
% Color
...
\begin{document}
	...
	\setstretch{1} % 1.5 línea de interlineado antes esta a 1 para la portada
